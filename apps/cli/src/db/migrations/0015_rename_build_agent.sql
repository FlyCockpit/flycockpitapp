...
-- `active_agent` explicitly (the app sets it from the config-resolved
-- default primary agent — `DefaultPrimaryAgent::agent_name()` — or inherits
-- the parent's value on fork). No code reads
