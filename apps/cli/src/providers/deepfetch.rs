...
pub(crate) struct DeepfetchScope {
    pub provider: Option<String>,
    pub model: Option<String>,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct DeepfetchPlan {
    pub providers: usize,
    pub models: usize,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct DeepfetchTarget {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct EndpointProbeRequest {
    pub provider_id: String,
    pub model_id: String,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct ContextProbeRequest {
    pub provider_id: String,
    pub model_id: String,
    pub endpoint: ProbeEndpoint,
    pub max_tokens: u32,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct ProbeHttpError {
    pub status: u16,
    pub body: String,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) enum ProbeRawOutcome {
    Works,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) enum EndpointProbeOutcome {
    Works,
    Incompatible,
    Entitlement,
    RateLimited,
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) enum ContextProbeOutcome {
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) enum DeepfetchApplyReport {
    Applied {
        endpoint: WireApi,
...
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(crate) enum EndpointSelectionNote {
    Explicit,
    Pinned,
    AutoDetectedAfterBothWorked,
}

pub(crate) trait DeepfetchProbeClient {
    fn probe_endpoint<'a>(
        &'a mut self,
...
pub(crate) struct HttpDeepfetchProbeClient {
    resolved: BTreeMap<String, ResolvedRequest>,
    timeout: Duration,
}

impl HttpDeepfetchProbeClient {
    pub(crate) fn new(resolved: BTreeMap<String, ResolvedRequest>, timeout: Duration) -> Self {
...
pub(crate) fn collect_deepfetch_targets(
    cfg: &ProvidersConfig,
...
pub(crate) fn plan_deepfetch(targets: &[DeepfetchTarget]) -> DeepfetchPlan {
...
pub(crate) fn deepfetch_confirmation_message(plan: &DeepfetchPlan) -> String {
    format!(
...
pub(crate) fn should_run_deepfetch(
    mode: DeepfetchMode,
    confirmed: bool,
    is_terminal: bool,
) -> Result<bool> {
...
pub(crate) async fn probe_target<C: DeepfetchProbeClient>(
    client: &mut C,
