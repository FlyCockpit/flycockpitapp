...
impl From<crate::capability_ceiling::CapabilityCeilingError> for RemotePublicPolicyError {
    fn from(error: crate::capability_ceiling::CapabilityCeilingError) -> Self {
        match error {
            crate::capability_ceiling::CapabilityCeilingError::Ceiling(message) => {
                Self::Ceiling(message)
            }
            crate::capability_ceiling::CapabilityCeilingError::Capability(message) => {
