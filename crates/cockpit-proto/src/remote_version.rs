...
//! registry, in any fixture, or in any test. The protocol was reset to 1
//! before launch; a change to that constant updates tuple `0x0001`'s recorded
//! application component in place without editing this registry.
//!
