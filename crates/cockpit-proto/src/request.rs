...
macro_rules! command {
    ($with_commands:ident $(, $context:ident)*) => {
        $with_commands! { ($($context),*) [
            ...
            (Request::DeleteSealedValue { session_id, value_id }, "delete_sealed_value", owner_only, field(session_id), true, transactional_mutation, sql_transaction, serialized, none, "session_id:Uuid|value_id:String", [session_id: Uuid => session, value_id: String => param]);
            ...
            (Request::CreateProjectNote { project_root, name }, "create_project_note", owner_only, none, true, transactional_mutation, sql_transaction, serialized, path(project_root), "project_root:String|name:String", [project_root: String => project_root, name: String => param]);
            (Request::SetProjectNoteContent { project_root, id, content }, "set_project_note_content", owner_only, none, true, transactional_mutation, sql_transaction, serialized, path(project_root), "project_root:String|id:Uuid|content:String", [project_root: String => project_root, id: Uuid => param, content: String => param]);
            (Request::RenameProjectNote { project_root, id, name }, "rename_project_note", owner_only, none, true, transactional_mutation, sql_transaction, serialized, path(project_root), "project_root:String|id:Uuid|name:String", [project_root: String => project_root, id: Uuid => param, name: String => param]);
            (Request::DeleteProjectNote { project_root, id }, "delete_project_note", owner_only, none, true, transactional_mutation, sql_transaction, serialized, path(project_root), "project_root:String|id:Uuid", [project_root: String => project_root, id: Uuid => param]);
            ...
            (Request::Curator { project_root, action }, "curator", owner_only, none, true, idempotent_adapter_mutation, durable_dispatch_key(dispatch_key_and_generation), serialized, path(project_root), "project_root:String|action:CuratorAction", [project_root: String => project_root, action: CuratorAction => param]);
            ...
            (Request::FsDelete { project_root, path }, "fs_delete", owner_only, none, true, idempotent_adapter_mutation, staged_filesystem_commit(staged_artifact_fingerprints_and_fsync_barriers), serialized, path(path), "project_root:String|path:String", [project_root: String => project_root, path: String => file_existing(project_root)]);
            ...
            (Request::ShareSession { session_id, shared }, "share_session", owner_only, field(session_id), true, transactional_mutation, sql_transaction, serialized, none, "session_id:Uuid|shared:bool", [session_id: Uuid => session, shared: bool => param]);
            ...
            (Request::RecordUsage { kind, key, project_id }, "record_usage", owner_only, none, true, transactional_mutation, sql_transaction, serialized, none, "kind:UsageKind|key:String|project_id:Option<String>", [kind: UsageKind => param, key: String => param, project_id: Option<String> => project]);
