...
macro_rules! command {
    ($with_commands:ident $(, $context:ident)*) => {
        $with_commands! { ($($context),*) [
            ...
            (Request::SubagentTranscript { session_id, .. }, "subagent_transcript", custom(authorize_subagent_transcript), field(session_id), false, serialized, none);
            ...
            (Request::ListAssistants, "list_assistants", owner_only, none, false, serialized, none);
            ...
            (Request::ExportSessionData { session_id, .. }, "export_session_data", owner_only, field(session_id), false, serialized, none);
            ...
            (Request::FsList { project_root, .. }, "fs_list", project_files(project_root), none, false, serialized, none);
            (Request::FsStat { project_root, .. }, "fs_stat", project_files(project_root), none, false, serialized, none);
            (Request::FsRead { project_root, .. }, "fs_read", project_files(project_root), none, false, serialized, none);
            ...
            (Request::GitStatus { project_root }, "git_status", project_files(project_root), none, false, serialized, none);
            (Request::GitDiffFile { project_root, path }, "git_diff_file", project_files(project_root), none, false, serialized, path(path));
            ...
            (Request::ListSessions { .. }, "list_sessions", public_read, none, false, serialized, none);
            (Request::ReadSessionMessages { session_id, .. }, "read_session_messages", custom(authorize_read_session_messages), field(session_id), false, serialized, none);
            (Request::SessionLiveStatus { .. }, "session_live_status", public_read, none, false, serialized, none);
            ...
            (Request::ListSkills { project_root }, "list_skills", project_read(project_root), none, false, serialized, none);
            (Request::ResourceSnapshot, "resource_snapshot", owner_only, none, false, serialized, none);
            ...
            (Request::ListScheduledJobs { .. }, "list_scheduled_jobs", owner_only, none, false, serialized, none);
            ...
            (Request::ListAgents, "list_agents", owner_only, none, false, serialized, none);
            (Request::ListModels { .. }, "list_models", owner_only, none, false, serialized, none);
            ...
            (Request::DaemonStatus, "daemon_status", public_read, none, false, serialized, none);
            ...
            (Request::GetUsageCounts { .. }, "get_usage_counts", owner_only, none, false, serialized, none);
            (Request::StatsRollup { .. }, "stats_rollup", owner_only, none, false, serialized, none);
            (Request::GuidanceEstimate { project_root, .. }, "guidance_estimate", project_read(project_root), none, false, serialized, none);
