...
macro_rules! command {
    ($with_commands:ident $(, $context:ident)*) => {
        $with_commands! { ($($context),*) [
            ...
            (Request::ListGuidanceProposals, "list_guidance_proposals", owner_only, none, false, local_only, none, serialized, none, "-", []);
            ...
            (Request::ReviewGuidanceProposal { proposal_id, decision }, "review_guidance_proposal", owner_only, none, true, local_only, none, serialized, none, "proposal_id:Uuid|decision:crate::GuidanceProposalDecision", [proposal_id: Uuid => param, decision: crate::GuidanceProposalDecision => param]);
