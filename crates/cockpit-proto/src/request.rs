...
macro_rules! command {
    ($with_commands:ident $(, $context:ident)*) => {
        $with_commands! { ($($context),*) [
            ...
            (Request::SteerDelegation { session_id, task_call_id, label, message }, "steer_delegation", custom(authorize_steer_delegation), field(session_id), true, nonrepeatable_mutation, nonrepeatable_dispatch, serialized, none, "session_id:Uuid|task_call_id:String|label:String|message:String", [session_id: Uuid, task_call_id: String, label: String, message: String], [session(session_id)]);
            ...
            (Request::UploadAttachmentChunk { upload_id, offset, data_base64 }, "upload_attachment_chunk", custom(authorize_attachment_upload_step), attached, true, idempotent_adapter_mutation, domain_transaction(domain_result_tuple), serialized, none, "upload_id:Uuid|offset:u64|data_base64:String", [upload_id: Uuid, offset: u64, data_base64: String], [upload(upload_id)]);
            (Request::FinishAttachmentUpload { upload_id }, "finish_attachment_upload", custom(authorize_attachment_upload_step), attached, true, idempotent_adapter_mutation, domain_transaction(domain_result_tuple), serialized, none, "upload_id:Uuid", [upload_id: Uuid], [upload(upload_id)]);
            (Request::CancelAttachmentUpload { upload_id }, "cancel_attachment_upload", custom(authorize_attachment_upload_step), attached, true, idempotent_adapter_mutation, domain_transaction(domain_result_tuple), serialized, none, "upload_id:Uuid", [upload_id: Uuid], [upload(upload_id)]);
            (Request::RemoveQueuedUserMessage { queue_item_id }, "remove_queued_user_message", session_writer, attached, true, transactional_mutation, sql_transaction, serialized, none, "queue_item_id:Uuid", [queue_item_id: Uuid], [queue(queue_item_id)]);
            ...
            (Request::ResumePausedWork { session_id }, "resume_paused_work", session_row_writer(session_id), field(session_id), true, transactional_mutation, sql_transaction, serialized, none, "session_id:Uuid", [session_id: Uuid], [session(session_id)]);
            (Request::CancelPausedWork { session_id }, "cancel_paused_work", session_row_writer(session_id), field(session_id), true, transactional_mutation, sql_transaction, serialized, none, "session_id:Uuid", [session_id: Uuid], [session(session_id)]);
            (Request::RepairResume { session_id }, "repair_resume", session_writer, field(session_id), true, transactional_mutation, sql_transaction, serialized, none, "session_id:Uuid", [session_id: Uuid], [session(session_id)]);
            (Request::GoalStatus { session_id }, "goal_status", session_row_reader(session_id), field(session_id), false, read_only, none, serialized, none, "session_id:Uuid", [session_id: Uuid], [session(session_id)]);
            (Request::CreateGoal { session_id, objective, token_budget }, "create_goal", session_row_writer(session_id), field(session_id), true, transactional_mutation, sql_transaction, serialized, none, "session_id:Uuid|objective:String|token_budget:Option<i64>", [session_id: Uuid, objective: String, token_budget: Option<i64>], [session(session_id)]);
            (Request::SetGoalStatus { session_id, status }, "set_goal_status", session_row_writer(session_id), field(session_id), true, transactional_mutation, sql_transaction, serialized, none, "session_id:Uuid|status:GoalDisposition", [session_id: Uuid, status: GoalDisposition], [session(session_id)]);
            (Request::ClearGoal { session_id }, "clear_goal", session_row_writer(session_id), field(session_id), true, transactional_mutation, sql_transaction, serialized, none, "session_id:Uuid", [session_id: Uuid], [session(session_id)]);
            (Request::PinMessage { session_id, seq }, "pin_message", session_row_writer(session_id), field(session_id), true, transactional_mutation, sql_transaction, serialized, none, "session_id:Uuid|seq:i64", [session_id: Uuid, seq: i64], [session(session_id)]);
            (Request::UnpinMessage { session_id, seq }, "unpin_message", session_row_writer(session_id), field(session_id), true, transactional_mutation, sql_transaction, serialized, none, "session_id:Uuid|seq:i64", [session_id: Uuid, seq: i64], [session(session_id)]);
            (Request::TogglePinnedMessage { session_id, seq }, "toggle_pinned_message", session_row_writer(session_id), field(session_id), true, transactional_mutation, sql_transaction, serialized, none, "session_id:Uuid|seq:i64", [session_id: Uuid, seq: i64], [session(session_id)]);
            (Request::CountPinnedMessages { session_id }, "count_pinned_messages", session_row_reader(session_id), field(session_id), false, read_only, none, concurrent, none, "session_id:Uuid", [session_id: Uuid], [session(session_id)]);
            (Request::ListPinnedMessageSeqs { session_id }, "list_pinned_message_seqs", session_row_reader(session_id), field(session_id), false, read_only, none, concurrent, none, "session_id:Uuid", [session_id: Uuid], [session(session_id)]);
            (Request::ListPinnedMessagesWithText { session_id }, "list_pinned_messages_with_text", session_row_reader(session_id), field(session_id), false, read_only, none, concurrent, none, "session_id:Uuid", [session_id: Uuid], [session(session_id)]);
            (Request::PinnedMessageState { session_id }, "pinned_message_state", session_row_reader(session_id), field(session_id), false, read_only, none, concurrent, none, "session_id:Uuid", [session_id: Uuid], [session(session_id)]);
            (Request::ListSealedValues { session_id }, "list_sealed_values", owner_only, field(session_id), false, read_only, none, concurrent, none, "session_id:Uuid", [session_id: Uuid], [session(session_id)]);
            (Request::DeleteSealedValue { session_id, value_id }, "delete_sealed_value", owner_only, field(session_id), true, transactional_mutation, sql_transaction, serialized, none, "session_id:Uuid|value_id:String", [session_id: Uuid, value_id: String], [session(session_id)]);
            (Request::ListProjectNotes { project_root }, "list_project_notes", owner_only, none, true, read_only, none, serialized, path(project_root), "project_root:String", [project_root: String], [project_root(project_root)]);
            (Request::CreateProjectNote { project_root, name }, "create_project_note", owner_only, none, true, transactional_mutation, sql_transaction, serialized, path(project_root), "project_root:String|name:String", [project_root: String, name: String], [project_root(project_root)]);
            (Request::SetProjectNoteContent { project_root, id, content }, "set_project_note_content", owner_only, none, true, transactional_mutation, sql_transaction, serialized, path(project_root), "project_root:String|id:Uuid|content:String", [project_root: String, id: Uuid, content: String], [project_root(project_root)]);
            (Request::RenameProjectNote { project_root, id, name }, "rename_project_note", owner_only, none, true, transactional_mutation, sql_transaction, serialized, path(project_root), "project_root:String|id:Uuid|name:String", [project_root: String, id: Uuid, name: String], [project_root(project_root)]);
            (Request::DeleteProjectNote { project_root, id }, "delete_project_note", owner_only, none, true, transactional_mutation, sql_transaction, serialized, path(project_root), "project_root:String|id:Uuid", [project_root: String, id: Uuid], [project_root(project_root)]);
            (Request::SetWorkspaceTrust { project_root, mode, expected_config_generation }, "set_workspace_trust", owner_only, none, true, idempotent_adapter_mutation, durable_desired_state(desired_state_generation_and_observed_digest), serialized, path(project_root), "project_root:String|mode:WorkspaceTrustMode|expected_config_generation:u64", [project_root: String, mode: WorkspaceTrustMode, expected_config_generation: u64], [project_root(project_root)]);
            (Request::GetStartupDisclosures { project_root }, "get_startup_disclosures", owner_only, none, false, read_only, none, serialized, path(project_root), "project_root:String", [project_root: String], [project_root(project_root)]);
            ...
            (Request::ResolveAssistantSession { assistant_id, project_root, mode }, "resolve_assistant_session", owner_only, none, true, transactional_mutation, sql_transaction, serialized, path(project_root), "assistant_id:String|project_root:String|mode:AssistantSessionResolutionMode", [assistant_id: String, project_root: String, mode: AssistantSessionResolutionMode], [project_root(project_root)]);
            ...
            (Request::Curator { project_root, action }, "curator", owner_only, none, true, idempotent_adapter_mutation, durable_dispatch_key(dispatch_key_and_generation), serialized, path(project_root), "project_root:String|action:CuratorAction", [project_root: String, action: CuratorAction], [project_root(project_root)]);
            ...
            (Request::FsList { project_root, path, show_hidden }, "fs_list", project_files(project_root), none, false, read_only, none, concurrent, none, "project_root:String|path:String|show_hidden:bool", [project_root: String, path: String, show_hidden: bool], [project_root(project_root), file_path(project_root, path)]);
            (Request::FsStat { project_root, path }, "fs_stat", project_files(project_root), none, false, read_only, none, concurrent, none, "project_root:String|path:String", [project_root: String, path: String], [project_root(project_root), file_path(project_root, path)]);
            (Request::FsRead { project_root, path, base64 }, "fs_read", project_files(project_root), none, false, read_only, none, concurrent, none, "project_root:String|path:String|base64:bool", [project_root: String, path: String, base64: bool], [project_root(project_root), file_path(project_root, path)]);
            (Request::FsWrite { project_root, path, content, base_hash }, "fs_write", project_files(project_root), none, true, idempotent_adapter_mutation, staged_filesystem_commit(staged_artifact_fingerprints_and_fsync_barriers), serialized, path(path), "project_root:String|path:String|content:String|base_hash:Option<String>", [project_root: String, path: String, content: String, base_hash: Option<String>], [project_root(project_root), file_path(project_root, path)]);
            (Request::FsCreateDir { project_root, path }, "fs_create_dir", project_files(project_root), none, true, idempotent_adapter_mutation, staged_filesystem_commit(staged_artifact_fingerprints_and_fsync_barriers), serialized, path(path), "project_root:String|path:String", [project_root: String, path: String], [project_root(project_root), file_path(project_root, path)]);
            (Request::FsRename { project_root, from_path, to_path }, "fs_rename", project_files(project_root), none, true, idempotent_adapter_mutation, staged_filesystem_commit(staged_artifact_fingerprints_and_fsync_barriers), serialized, rename(from_path, to_path), "project_root:String|from_path:String|to_path:String", [project_root: String, from_path: String, to_path: String], [project_root(project_root), file_path(project_root, from_path), file_path(project_root, to_path)]);
            (Request::FsDelete { project_root, path }, "fs_delete", owner_only, none, true, idempotent_adapter_mutation, staged_filesystem_commit(staged_artifact_fingerprints_and_fsync_barriers), serialized, path(path), "project_root:String|path:String", [project_root: String, path: String], [project_root(project_root), file_path(project_root, path)]);
            (Request::GitStatus { project_root }, "git_status", project_files(project_root), none, false, read_only, none, concurrent, none, "project_root:String", [project_root: String], [project_root(project_root)]);
            (Request::GitDiffFile { project_root, path }, "git_diff_file", project_files(project_root), none, false, read_only, none, concurrent, path(path), "project_root:String|path:String", [project_root: String, path: String], [project_root(project_root), file_path(project_root, path)]);
            ...
            (Request::AttachTerminal { terminal_id, cols, rows }, "attach_terminal", terminal, none, false, read_only, none, serialized, none, "terminal_id:Uuid|cols:u16|rows:u16", [terminal_id: Uuid, cols: u16, rows: u16], [terminal(terminal_id)]);
            (Request::TerminalInput { terminal_id, bytes }, "terminal_input", terminal, none, false, nonrepeatable_mutation, nonrepeatable_dispatch, serialized, none, "terminal_id:Uuid|bytes:Vec<u8>", [terminal_id: Uuid, bytes: Vec<u8>], [terminal(terminal_id)]);
            (Request::TerminalResize { terminal_id, cols, rows }, "terminal_resize", terminal, none, false, nonrepeatable_mutation, nonrepeatable_dispatch, serialized, none, "terminal_id:Uuid|cols:u16|rows:u16", [terminal_id: Uuid, cols: u16, rows: u16], [terminal(terminal_id)]);
            (Request::CloseTerminal { terminal_id }, "close_terminal", terminal, none, true, idempotent_adapter_mutation, durable_dispatch_key(dispatch_key_and_generation), serialized, none, "terminal_id:Uuid", [terminal_id: Uuid], [terminal(terminal_id)]);
            (Request::LspControl { project_root, server_id, action }, "lsp_control", custom(authorize_lsp_control), attached, true, idempotent_adapter_mutation, durable_dispatch_key(dispatch_key_and_generation), serialized, none, "project_root:String|server_id:String|action:LspControlAction", [project_root: String, server_id: String, action: LspControlAction], [project_root(project_root)]);
            (Request::ResolveInterrupt { interrupt_id, response }, "resolve_interrupt", session_writer, attached, true, idempotent_adapter_mutation, durable_dispatch_key(dispatch_key_and_generation), serialized, none, "interrupt_id:Uuid|response:ResolveResponse", [interrupt_id: Uuid, response: ResolveResponse], [interrupt(interrupt_id)]);
            (Request::ListSessions { project_id, parent_session_id }, "list_sessions", public_read, none, false, read_only, none, concurrent, none, "project_id:Option<String>|parent_session_id:Option<Uuid>", [project_id: Option<String>, parent_session_id: Option<Uuid>], [project(project_id)]);
            (Request::ReadSessionMessages { session_id, before_seq, limit }, "read_session_messages", custom(authorize_read_session_messages), field(session_id), false, read_only, none, concurrent, none, "session_id:Uuid|before_seq:Option<i64>|limit:u32", [session_id: Uuid, before_seq: Option<i64>, limit: u32], [session(session_id)]);
            (Request::ReadClientSubmissionReceipt { session_id, client_submission_id }, "read_client_submission_receipt", custom(authorize_read_session_messages), field(session_id), false, read_only, none, concurrent, none, "session_id:Uuid|client_submission_id:Uuid", [session_id: Uuid, client_submission_id: Uuid], [session(session_id)]);
            (Request::ReadHistoryPage { session_id, before_seq, limit }, "read_history_page", custom(authorize_read_history_page), field(session_id), false, read_only, none, concurrent, none, "session_id:Uuid|before_seq:Option<i64>|limit:u32", [session_id: Uuid, before_seq: Option<i64>, limit: u32], [session(session_id)]);
            (Request::ReadSubagentHistoryPage { session_id, task_call_id, label, before_seq, limit }, "read_subagent_history_page", custom(authorize_read_subagent_history_page), field(session_id), false, read_only, none, concurrent, none, "session_id:Uuid|task_call_id:String|label:String|before_seq:Option<i64>|limit:u32", [session_id: Uuid, task_call_id: String, label: String, before_seq: Option<i64>, limit: u32], [session(session_id)]);
            ...
            (Request::ArchiveSession { session_id, cascade }, "archive_session", session_row_writer(session_id), field(session_id), true, transactional_mutation, sql_transaction, serialized, none, "session_id:Uuid|cascade:bool", [session_id: Uuid, cascade: bool], [session(session_id)]);
            (Request::UnarchiveSession { session_id }, "unarchive_session", session_row_writer(session_id), field(session_id), true, transactional_mutation, sql_transaction, serialized, none, "session_id:Uuid", [session_id: Uuid], [session(session_id)]);
            ...
            (Request::DiscardSession { session_id }, "discard_session", session_row_writer(session_id), field(session_id), true, transactional_mutation, sql_transaction, serialized, none, "session_id:Uuid", [session_id: Uuid], [session(session_id)]);
            ...
            (Request::RenameSession { session_id, title }, "rename_session", session_row_writer(session_id), field(session_id), true, transactional_mutation, sql_transaction, serialized, none, "session_id:Uuid|title:String", [session_id: Uuid, title: String], [session(session_id)]);
            (Request::ShareSession { session_id, shared }, "share_session", owner_only, field(session_id), true, transactional_mutation, sql_transaction, serialized, none, "session_id:Uuid|shared:bool", [session_id: Uuid, shared: bool], [session(session_id)]);
            (Request::RecordSessionNote { session_id, text }, "record_session_note", session_row_writer(session_id), field(session_id), true, transactional_mutation, sql_transaction, serialized, none, "session_id:Uuid|text:String", [session_id: Uuid, text: String], [session(session_id)]);
            (Request::DeleteSession { session_id }, "delete_session", session_row_writer(session_id), field(session_id), true, transactional_mutation, sql_transaction, serialized, none, "session_id:Uuid", [session_id: Uuid], [session(session_id)]);
            (Request::GetInventoryBundle { project_root, session_id, selected_agent }, "get_inventory_bundle", session_row_reader(session_id), field(session_id), false, read_only, none, concurrent, path(project_root), "project_root:String|session_id:Uuid|selected_agent:String", [project_root: String, session_id: Uuid, selected_agent: String], [session(session_id), project_root(project_root)]);
            (Request::ResourceSnapshot, "resource_snapshot", owner_only, none, false, read_only, none, concurrent, none, "-", [], []);
            (Request::PromoteResource { request_id, session_id }, "promote_resource", owner_only, option_field(session_id), true, idempotent_adapter_mutation, durable_dispatch_key(dispatch_key_and_generation), serialized, none, "request_id:String|session_id:Option<Uuid>", [request_id: String, session_id: Option<Uuid>], [session(session_id)]);
            (Request::CreateScheduledJob { job }, "create_scheduled_job", owner_only, none, true, transactional_mutation, sql_transaction, serialized, none, "job:ScheduledJobCreate", [job: ScheduledJobCreate], [scheduled(job)]);
            ...
            (Request::RecordUsage { kind, key, project_id }, "record_usage", owner_only, none, true, transactional_mutation, sql_transaction, serialized, none, "kind:UsageKind|key:String|project_id:Option<String>", [kind: UsageKind, key: String, project_id: Option<String>], [project(project_id)]);
            (Request::GetUsageCounts { project_id }, "get_usage_counts", owner_only, none, false, read_only, none, concurrent, none, "project_id:Option<String>", [project_id: Option<String>], [project(project_id)]);
            (Request::StatsRollup { project_id, range, by_role }, "stats_rollup", owner_only, none, false, read_only, none, concurrent, none, "project_id:Option<String>|range:StatsRange|by_role:bool", [project_id: Option<String>, range: StatsRange, by_role: bool], [project(project_id)]);
            (Request::GuidanceEstimate { project_root, provider, model }, "guidance_estimate", project_read(project_root), none, false, read_only, none, concurrent, none, "project_root:String|provider:Option<String>|model:Option<String>", [project_root: String, provider: Option<String>, model: Option<String>], [project_root(project_root), provider_model(provider, model)]);
...
macro_rules! command_remote_class_tag {
    (($tag_value:ident) [$(($pattern:pat, $tag:literal, $authz:ident $(($authz_arg:ident))?, $session:ident $(($session_arg:ident))?, $mutating:literal, $remote_class:ident, $recovery:ident $(($recovery_evidence:ident))?, $ordering:ident, $audit_path:ident $(($($audit_arg:ident),+))?, $fcor_schema:literal, [$($fcor_field:ident: $fcor_type:ty),*], [$($resource_role:tt)*]);)+]) => {{
...
macro_rules! command_typed_fcor_fields {
    (($request:ident) [$(($pattern:pat, $tag:literal, $authz:ident $(($authz_arg:ident))?, $session:ident $(($session_arg:ident))?, $mutating:literal, $remote_class:ident, $recovery:ident $(($recovery_evidence:ident))?, $ordering:ident, $audit_path:ident $(($($audit_arg:ident),+))?, $fcor_schema:literal, [$($fcor_field:ident: $fcor_type:ty),*], [$($resource_role:tt)*]);)+]) => {{
        match $request {
            $($pattern => {
...
mod tests {
    ...
    macro_rules! command_tags {
        (($($context:ident),*) [$(($pattern:pat, $tag:literal, $authz:ident $(($authz_arg:ident))?, $session:ident $(($session_arg:ident))?, $mutating:literal, $remote_class:ident, $recovery:ident $(($recovery_evidence:ident))?, $ordering:ident, $audit_path:ident $(($($audit_arg:ident),+))?, $fcor_schema:literal, [$($fcor_field:ident: $fcor_type:ty),*], [$($resource_role:tt)*]);)+]) => {{
            vec![$($tag),+]
        }};
    }
