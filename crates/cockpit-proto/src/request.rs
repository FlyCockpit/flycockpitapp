    ...
    pub fn validate_semantics(&self) -> std::result::Result<(), String> {
        ...
        match self {
            ...
            Self::CreateImageSidecarGrant {
                ...
                validate_owner_project_root(project_root)?;
                if *config_generation == 0 || destination.is_empty() || destination.len() > 2048 {
