...
impl App {
    ...
    fn apply_sticky_visibility(&mut self, pane: Rect, visible: bool) {
        ...
        if was_visible != visible {
            // The sticky header changes the coordinate space of the transcript.
            // Both completed selections and active drags use screen coordinates,
            // so retaining either would make future copy or paint operations
            // address the wrong content.
